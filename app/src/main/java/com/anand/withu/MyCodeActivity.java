...
public class MyCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_code);textView_code = findViewById(R.id.Codeview);
        auth = (FirebaseAuth) FirebaseAuth.getInstance(FirebaseApp.initializeApp(this));
        user = auth.getCurrentUser();

        ProgressDialog dialog = new ProgressDialog(MyCodeActivity.this);
    ...
    public void MyCode_back(View v){
        Intent i = new Intent(MyCodeActivity.this, UserLocationMainActivity.class);
        startActivity(i);
    }
