...
import com.anand.withu.Models.CircleJoin;
import com.anand.withu.Models.MarkerName;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_joinCircle) {
            ...
            if (user != null) {
                auth.signOut();
                finish();
                Intent myIntent = new Intent(UserLocationMainActivity.this, SignIn.class);
            ...
            Intent intent = new Intent(UserLocationMainActivity.this, MyCodeActivity.class);
            startActivity(intent);
        }
